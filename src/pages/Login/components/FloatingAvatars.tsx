...
const FloatingAvatars = () => {
  ...
  useEffect(() => {
    ...
    const showRandomBubble = () => {
      ...
      const newBubbleText = conversations[Math.floor(Math.random() * conversations.length)];

      setAvatars(prev => prev.map((avatar, idx) =>
        idx === randomIndex
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-welcome-to-office-large bg-no-repeat bg-cover bg-center" />
